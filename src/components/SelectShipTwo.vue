<template>
  <div class="component__container">
    <div class="selected-ship__container" @click="dataStore.toggleShipTwoSelection()">
      <div class="selected-ship-name">{{ dataStore.shipTwoName }}</div>
      <div class="select_symbol">
        <ChevrondownIcon
          v-if="!dataStore.shipTwoSelectionOn"
          class="icon-chevron"
        ></ChevrondownIcon>
    ...
    <Transition>
      <div v-if="dataStore.shipTwoSelectionOn" class="shiplist_dropdown_container">
        <div
          @click="dataStore.selectShipTwo(ship)"
